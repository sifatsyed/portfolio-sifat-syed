              ...
              <section className={styles.heroSection}>
                <div className={styles.heroContent}>
                  ...
                  <p className={styles.heroDescription}>
                    ...
                    help bring great ideas to life. Whether you need a complete
                    product redesign, design system, or UX consultation, I'd
                  ...
                  <div className={styles.infoSection}>
                    ...
                    <div className={styles.availabilitySection}>
                      ...
                      <p className={styles.availabilityNote}>
                        I typically take on 1-2 major projects at a time to
                        ensure quality and focus. Next availability starts in
                        March 2024.
                      </p>
                    </div>
                    ...
                    <div className={styles.expectationsSection}>
                      <h3 className={styles.expectationsTitle}>
                        What to Expect
                      </h3>
                ...
                <div className={styles.faqGrid}>
                  <div className={styles.faqItem}>
                    ...
                    <p className={styles.faqAnswer}>
                      I follow a user-centered design approach: research,
                      ideation, prototyping, testing, and iteration. Every
                      project starts with understanding your users and business
                      goals.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p className={styles.faqAnswer}>
                      It varies by scope: design systems (3-6 months), app
                      redesigns (2-4 months), UX audits (2-4 weeks). I'll
                      provide a detailed timeline in the proposal.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion}>
                    ...
                    <p className={styles.faqAnswer}>
                      Absolutely! I collaborate closely with developers and
                      provide detailed specs, design systems, and ongoing
                  ...
                  <div className={styles.faqItem}>
                    ...
                    <p className={styles.faqAnswer}>
                      Primarily Figma for design, with additional tools like
                      Principle for prototyping, Miro for collaboration, and
                      various user research platforms.
                    </p>
                  </div>
                </div>
              </section>
